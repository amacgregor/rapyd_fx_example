defmodule RapydFxExampleWeb.WalletControllerTest do
  use RapydFxExampleWeb.ConnCase

  import RapydFxExample.RapydFixtures

  @create_attrs %{ewallet_id: "some ewallet_id", name: "some name", url: "some url"}
  ...
  describe "update wallet" do
    ...
    test "redirects when data is valid", %{conn: conn, wallet: wallet} do
      ...
      assert html_response(conn, 200) =~ "some updated ewallet_id"
    end
